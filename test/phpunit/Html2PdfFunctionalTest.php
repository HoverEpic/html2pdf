...
/**
 * \file    test/functional/Html2PdfFunctionalTest.php
 * \ingroup html2pdf
 ...
 *
 * @package Testhtml2pdf
 */
class Html2PdfFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/html2pdf/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('html2pdf/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/html2pdf/admin/about.php');
		$this->authenticate();
		return $this->assertContains('html2pdf/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('html2pdfwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modHtml2Pdf_Html2PdfTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modHtml2Pdf_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
