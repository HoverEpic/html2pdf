...
dol_include_once('/html2pdf/class/myobject.class.php');



/**
 * \file    html2pdf/class/api_html2pdf.class.php
 * \ingroup html2pdf
 * \brief   File for API management of myobject.
 */

/**
 * API class for html2pdf myobject
 *
 * @smart-auto-routing false
 * @access protected
 * @class  DolibarrApiAccess {@requires user,external}
 */
class Html2PdfApi extends DolibarrApi
{
    /**
